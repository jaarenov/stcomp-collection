...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "knitter","knitter",0,"knitter.core.js","es5-build-disabled.js","hydrated",[["kn-button","kn-button",1,[["clear",1,0,1,3],["color",1,0,1,2],["disabled",1,0,1,3],["full",1,0,1,3],["outline",1,0,1,3],["round",1,0,1,3],["size",1,0,1,2],["value",1,0,1,2]]],["kn-code","kn-code",1,[["block",1,0,1,3],["element",7]]],["kn-option","kn-option",1,[["element",7],["selected",5],["value",2,0,1,2]],0,[["parent:change","setSelected"],["parent:load","setSelected"]]],["kn-select","kn-option",1,[["element",7],["open",5],["options",1],["placeholder",1,0,1,2],["text",5],["value",2,0,1,2]],0,[["window:click","closeForBlur"],["select","changeSelect"]]]],HTMLElement.prototype);